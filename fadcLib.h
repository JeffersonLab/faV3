...
#define FA_SUPPORTED_CTRL_FIRMWARE 0xBB
#define FA_SUPPORTED_CTRL_FIRMWARE_NUMBER 1
#define FA_SUPPORTED_PROC_FIRMWARE 0x1B07
...
#define FA_THR_ACCUMULATOR_SCALER_MODE_MASK     0x1000
...
#define FA_SPARSE_CONTROL_BYPASS (1 << 0)
#define FA_SPARSE_CONTROL_MODE_MASK 0x0000000E

/* 0x524 sparse status */
#define FA_SPARSE_STATUS_MASK 0x00000003
#define FA_SPARSE_STATUS_WAIT_CHANNEL_MASK (1 << 0)
#define FA_SPARSE_STATUS_ACTIVE (1 << 1)
#define FA_SPARSE_STATUS_CLEAR (1 << 31)
